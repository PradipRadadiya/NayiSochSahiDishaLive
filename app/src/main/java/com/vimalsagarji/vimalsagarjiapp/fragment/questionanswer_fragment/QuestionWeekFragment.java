...
public class QuestionWeekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (sharedpreferance.getId().equalsIgnoreCase("")) {
            mainurl = CommonUrl.Main_url + "questionanswer/viewallappquesweek/?page=";

        } else {
            mainurl = CommonUrl.Main_url + "questionanswer/viewallappquesweek/?uid=" + sharedpreferance.getId() + "&page=";
        }
