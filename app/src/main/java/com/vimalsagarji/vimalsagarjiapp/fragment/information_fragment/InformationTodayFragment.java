...
public class InformationTodayFragment extends Fragment {
    private View rootview;
    private SwipeRefreshLayout swipe_refresh;
    private RecyclerView recyclerView_qa;
    private LinearLayoutManager linearLayoutManager;
    private ArrayList<InformationItem> informationItemArrayList = new ArrayList<>();
    private RecyclerInformationAllAdapter recyclerInformationAllAdapter;
    //page count
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (sharedpreferance.getId().equalsIgnoreCase("")) {
            mainurl = CommonUrl.Main_url+"info/getallinfobycidtoday/?page=";

        } else {
            mainurl = CommonUrl.Main_url+"info/getallinfobycidtoday/?uid=" + sharedpreferance.getId() + "&page=";
        }
...
//        linearLayoutManager=new LinearLayoutManager(getActivity());
        ...
        recyclerInformationAllAdapter = new RecyclerInformationAllAdapter(getActivity(), informationItemArrayList);
        recyclerView_qa.setAdapter(recyclerInformationAllAdapter);
...
//            recyclerView_users.setVisibility(View.GONE);
        ...
        protected void onPostExecute(String s) {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("success")) {
                   ...
                   /* if (jsonArray.length() < 20 || jsonArray.length() == 0) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        informationItemArrayList.add(new InformationItem(id, Title, Description, Address, fulldate, View, Photo, viewed_user, is_viewed));

                    }

                    recyclerInformationAllAdapter.notifyDataSetChanged();
                }
            ...
            if (informationItemArrayList.isEmpty()) {
