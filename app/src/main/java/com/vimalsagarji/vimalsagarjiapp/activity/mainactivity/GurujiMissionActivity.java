...
public class GurujiMissionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_description.setText(CommonMethod.stripHtml(getResources().getString(R.string.about_guruji_mission_hnd)));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.txt_eng:
                txt_description.setText(getResources().getString(R.string.about_guruji_mission_eng));
                ...
                break;
            case R.id.txt_hnd:
                txt_description.setText(getResources().getString(R.string.about_guruji_mission_hnd));
                ...
                break;
            case R.id.txt_guj:
                txt_description.setText(getResources().getString(R.string.about_guruji_mission_guj));
                txt_eng.setTextColor(Color.BLACK);
                txt_hnd.setTextColor(Color.BLACK);
